...
public class WorldBoxDisc extends Thread {
    ...
    public static void init(){
        ...
        File porteDebloque2F = new File("resourses/sounds/rooms/doorOpened.wav");
        ...
        File cracklingFireF = new File("resourses/sounds/ambiant/cracklingFire.wav");
        ...
        File grabObjectF = new File("resourses/sounds/objects/grabItem.wav");
